...
export default function Pagina01() {
    return (
        <div className="max-h-[80vh] flex items-center justify-center bg-gradient-to-r from-[#8c52ff] to-[#1bdaff] p-8">
            <div className="bg-transparent border-8 border-white rounded-3xl shadow-lg p-8 w-full h-full flex flex-col md:flex-row">
                {/* Sección de texto */}
                <div className="w-full md:w-1/2 lg:w-2/3 p-8 flex flex-col items-start justify-between">
                    <div>
